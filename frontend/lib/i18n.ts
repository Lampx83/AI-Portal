...
export const translations: Record<Locale, Record<string, string>> = {
  vi: {
    ...
    "settings.subtitle": "Tùy chỉnh trải nghiệm sử dụng NEU Research",
    ...
    "settings.notificationsResearch": "Cập nhật nghiên cứu",
    ...
    "settings.privacyResearch": "Nghiên cứu công khai",
  ...
  en: {
    ...
    "settings.subtitle": "Customize your NEU Research experience",
    ...
    "settings.notificationsResearch": "Research updates",
    ...
    "settings.privacyResearch": "Research visible",
