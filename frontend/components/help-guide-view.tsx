...
export function HelpGuideView() {
  ...
  const helpCategories = [
      ...
      items: [
        {
          ...
          answer:
            "Trang Chào mừng là điểm bắt đầu. Bạn có thể bấm \"Bắt đầu sử dụng\" để vào Trợ lý chính và soạn bài, hoặc bấm \"Hướng dẫn sử dụng\" để xem hướng dẫn chi tiết.",
          tags: ["welcome", "bắt đầu"],
        },
        {
          question: "Làm thế nào để vào màn hình soạn bài?",
          answer:
            "Từ trang Chào mừng bấm \"Bắt đầu sử dụng\", hoặc từ sidebar chọn dự án để vào Trợ lý chính. Bạn sẽ thấy vùng soạn thảo ở giữa và có thể gõ hoặc bấm vào vùng trắng để bắt đầu soạn.",
          tags: ["soạn bài", "trợ lý chính"],
        },
        {
          question: "Sidebar có những phần nào?",
          answer:
            "Sidebar gồm: (1) Dự án của tôi — danh sách dự án; (2) Trợ lý — chọn trợ lý AI; (3) Lịch sử chat — các phiên trò chuyện. Bấm vào tiêu đề từng phần (hoặc nút mũi tên) để thu gọn/mở rộng.",
      ...
      items: [
        {
          ...
          answer:
            "Trong sidebar, bấm nút \"+\" hoặc \"Thêm dự án\" trong phần \"Dự án của tôi\". Điền tên và mô tả (nếu có) rồi lưu. Sau khi tạo, URL sẽ có tham số rid (id dự án) và bạn có thể lưu bài viết vào dự án đó.",
          tags: ["dự án", "tạo mới"],
        },
        {
          question: "Tại sao bấm Lưu lại báo \"Cần tạo hoặc chọn dự án\"?",
          answer:
            "Bài viết chỉ lưu được khi đã gắn với một dự án. Nếu bạn chưa chọn dự án (hoặc vào thẳng Trợ lý chính chưa có rid), hãy bấm \"Tạo dự án mới\" trong hộp thoại hoặc chọn một dự án từ sidebar. Sau khi có dự án, bấm Lưu lại sẽ lưu bài vào dự án đó.",
          tags: ["lưu", "dự án", "project"],
        },
        {
          question: "Làm sao chỉnh sửa tên/mô tả dự án?",
          answer:
            "Khi bấm vào một dự án trong sidebar (Dự án của tôi), giao diện chính hiển thị thông tin dự án (chỉ xem). Trợ lý chat nằm ở widget nổi góc dưới bên phải để bạn trò chuyện.",
      ...
      items: [
        {
          ...
          answer:
            "Vào Trợ lý chính, bấm vào vùng trắng lớn phía dưới (hoặc bất kỳ đâu trong khung soạn thảo). Con trỏ sẽ xuất hiện và bạn có thể gõ. Khi editor trống, bạn cũng có thể chọn mẫu nhanh: \"Tạo bài viết\", \"Đề cương\", \"Báo cáo tiến độ\" hoặc \"Thêm\" để chọn thêm mẫu.",
    ...
    },
    {
      ...
      items: [
        {
          question: "Trợ lý chính và chat floating là gì?",
          answer:
            "Trợ lý chính là màn hình chính để soạn bài (editor) và có khung chat nổi (floating) để trò chuyện với AI. Bạn vừa soạn vừa có thể hỏi AI qua khung chat. Các trợ lý khác (ví dụ Trợ lý Dữ liệu) có giao diện riêng, chọn từ sidebar.",
        ...
        },
        {
          ...
          answer:
            "Trong phần \"Trợ lý\" trên sidebar, bấm vào tên trợ lý (Trợ lý chính, Trợ lý Dữ liệu, v.v.) để chuyển. Bấm \"Xem thêm\" để mở danh sách đầy đủ các trợ lý có sẵn.",
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            AI Portal — cách dùng Trợ lý chính, dự án, soạn bài và lưu
          </p>
        </div>
              ...
              <Button variant="outline" className="justify-start h-auto py-3" asChild>
                <Link href="/assistants/central">
                  <div className="flex items-center gap-3 text-left">
                    ...
                    <div>
                      <div className="font-medium">Trợ lý chính</div>
