...
export function AssistantDataPane({
    ...
    return (
        <div className="flex flex-col h-full min-h-0">
            ...
            {/* Pagination: Luôn hiển thị ở cuối, không scroll */}
            {!isLoading && total > 0 && (
                <div className="mt-6 flex-shrink-0 flex flex-col sm:flex-row items-center justify-between gap-3 border-t pt-4">
