...
import { Download, Database, TrendingUp, Users, Plane, Building2, Factory, Wheat, DollarSign } from "lucide-react"
import {
  LineChart,
  Line,
  XAxis,
...
const datasets = [
  ...
  {
    title: "Thương mại",
    description: "Dữ liệu thống kê về hoạt động thương mại, bán lẻ và dịch vụ.",
    icon: Building2,
  ...
  return (
    <div className="flex flex-col h-full">
                  ...
                  <div>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      <LineChart data={datasets[0].sampleData?.vnIndex}>
                        ...
                        <Line type="monotone" dataKey="hnxIndex" stroke="#dc2626" strokeWidth={2} name="HNX-Index" />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
      ...
      <div className="flex-1 min-h-0">
        <ChatInterface assistantName="Dữ liệu NEU" researchContext={researchContext} />
      </div>
    </div>
  )
}
