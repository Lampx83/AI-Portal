    ...
    const sections = [
      ...
      },
      {
        ...
        items: [
          ...
          addItemKeys({ key: "CORS_ORIGIN", value: getSetting("CORS_ORIGIN", "http://localhost:3000,http://localhost:3002,http://127.0.0.1:3000"), descriptionKey: CONFIG_KEYS.desc.CORS_ORIGIN }),
