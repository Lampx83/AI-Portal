...
const DEFAULT_EN: Record<string, string> = {
  ...
  "header.banner": "⚠️ System is being finalized",
...
const DEFAULT_VI: Record<string, string> = {
  ...
  "header.banner": "⚠️ Hệ thống đang trong quá trình hoàn thiện",
...
const DEFAULT_JA: Record<string, string> = {
  ...
  "welcome.card2.description": "プロジェクトの作成と管理。各プロジェクトに記事を紐付け。",
  "welcome.card3.title": "記事を書く",
  "welcome.card3.description": "標準 10 ステップで記事の構成と執筆をサポート",
...
const DEFAULT_FR: Record<string, string> = {
  ...
  "header.banner": "⚠️ Le système est en cours de finalisation",
  ...
  "welcome.card2.description": "Créer et gérer des projets, chaque projet lié à un article.",
  "welcome.card3.title": "Rédiger un article",
  "welcome.card3.description": "Aide à la structuration et à la rédaction selon un processus en 10 étapes",
